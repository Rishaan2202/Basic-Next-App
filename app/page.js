...
export default function Page() {
  ...
  return <>
    ...
    <button><Link className='absolute left-1/2 top-[300px] transform -translate-x-1/2 -translate-y-1/2 bg-sky-800/50 m-2 p-2 w-[100px] rounded hover:bg-sky-700' href={"https://silver-space-invention-wr4j97vgx5jg256qv-3000.app.github.dev/home"}>Login</Link></button>
